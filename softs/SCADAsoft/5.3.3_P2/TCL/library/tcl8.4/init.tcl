...
# -*- tcl -*-
# Copyright (C) 2001 ActiveState Corporation Dec 07, 2004
#
# Extension code to tcl8.4/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.4.9.0.121397 Win32/x86, Tue Dec 07 9:11:09 AM Pacific Standard Time 2004
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1102439469}
	buildtime,fmt {Tue Dec 07 9:11:09 AM Pacific Standard Time 2004}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.9.0.121397 Win32/x86 @ Tue Dec 07 9:11:09 AM Pacific Standard Time 2004 / normal}
    }
}

package provide {ActiveTcl} {8.4.9.0.121397}
