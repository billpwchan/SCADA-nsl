...
# installed.
TCL_PREFIX='D:/SOFTS/Tcl849'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/SOFTS/Tcl849'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-LD:/SOFTS/Tcl849/lib -ltcl84'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/SOFTS/Tcl849/include'
...
TCL_PACKAGE_PATH='D:/SOFTS/Tcl849/lib D:/SOFTS/Tcl849/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/SOFTS/Tcl849/lib -ltclstub84'
...
TCL_STUB_LIB_PATH='D:/SOFTS/Tcl849/lib/tclstub84.lib'
