...
# installed.
TK_PREFIX='D:/SOFTS/Tcl849'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='D:/SOFTS/Tcl849'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-LD:/SOFTS/Tcl849/lib -ltk84'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-LD:/SOFTS/Tcl849/lib -ltkstub84'
...
TK_STUB_LIB_PATH='D:/SOFTS/Tcl849/lib/tkstub84.lib'
