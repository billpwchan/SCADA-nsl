...
#ifndef _TAO_IDL_FTRTECEVENTCOMMC_H_
#define _TAO_IDL_FTRTECEVENTCOMMC_H_
...
#if !defined (_FTRTECEVENTCOMM_INVALIDOBJECTID_CH_)
...
#if !defined (_FTRTECEVENTCOMM_AMI_PUSHCONSUMERHANDLER___PTR_CH_)
#define _FTRTECEVENTCOMM_AMI_PUSHCONSUMERHANDLER___PTR_CH_
...
#if !defined (_FTRTECEVENTCOMM_PUSHCONSUMER_CH_)
#define _FTRTECEVENTCOMM_PUSHCONSUMER_CH_
...
#if !defined (_FTRTECEVENTCOMM_AMI_PUSHCONSUMERHANDLER_CH_)
#define _FTRTECEVENTCOMM_AMI_PUSHCONSUMERHANDLER_CH_
  ...
  public:
    ...
    {
      return static_cast<AMI_PushConsumerHandler_ptr> (0);
    }
