...
#ifndef _TAO_IDL_G__BIN_P530_SRC_IMG_IDL_INPUTMGRBINDINGS_H_
#define _TAO_IDL_G__BIN_P530_SRC_IMG_IDL_INPUTMGRBINDINGS_H_
...
#if !defined (_INPUTMGRBINDINGSIDL__VAR_OUT_CH_)
#define _INPUTMGRBINDINGSIDL__VAR_OUT_CH_

class InputMgrBindingsIdl;
typedef InputMgrBindingsIdl *InputMgrBindingsIdl_ptr;

typedef
  TAO_Objref_Var_T<
      InputMgrBindingsIdl
    >
  InputMgrBindingsIdl_var;

typedef
  TAO_Objref_Out_T<
      InputMgrBindingsIdl
    >
  InputMgrBindingsIdl_out;
...
#if !defined (_INPUTMGRBINDINGSIDL_CH_)
#define _INPUTMGRBINDINGSIDL_CH_

class  InputMgrBindingsIdl
  : public virtual ::ScsProcessIdl
{
public:
  friend class TAO::Narrow_Utils<InputMgrBindingsIdl>;
  typedef InputMgrBindingsIdl_ptr _ptr_type;
  typedef InputMgrBindingsIdl_var _var_type;
  typedef InputMgrBindingsIdl_out _out_type;
  
  // The static operations.
  static InputMgrBindingsIdl_ptr _duplicate (InputMgrBindingsIdl_ptr obj);
  
  static void _tao_release (InputMgrBindingsIdl_ptr obj);
  
  static InputMgrBindingsIdl_ptr _narrow (::CORBA::Object_ptr obj);
  static InputMgrBindingsIdl_ptr _unchecked_narrow (::CORBA::Object_ptr obj);
  static InputMgrBindingsIdl_ptr _nil (void)
  {
    return static_cast<InputMgrBindingsIdl_ptr> (0);
  }
  ...
  virtual ::ScsStatusIdl getInputMgrObject (
      ::ScsProcessIdl_out server);
...
private:
  TAO::Collocation_Proxy_Broker *the_TAO_InputMgrBindingsIdl_Proxy_Broker_;

protected:
  // Concrete interface only.
  InputMgrBindingsIdl (void);
  
  // These methods travese the inheritance tree and set the
  // parents piece of the given class in the right mode.
  virtual void InputMgrBindingsIdl_setup_collocation (void);
  ...
  virtual ~InputMgrBindingsIdl (void);

private:
  // Private and unimplemented for concrete interfaces.
  InputMgrBindingsIdl (const InputMgrBindingsIdl &);
  
  void operator= (const InputMgrBindingsIdl &);
};
...
extern  ::CORBA::TypeCode_ptr const _tc_InputMgrBindingsIdl;
...
(*_TAO_InputMgrBindingsIdl_Proxy_Broker_Factory_function_pointer) (
...
#if !defined (_INPUTMGRBINDINGSIDL__TRAITS_)
#define _INPUTMGRBINDINGSIDL__TRAITS_
  
  template<>
  struct  Objref_Traits< ::InputMgrBindingsIdl>
  {
    static ::InputMgrBindingsIdl_ptr duplicate (
        ::InputMgrBindingsIdl_ptr p
      );
    static void release (
        ::InputMgrBindingsIdl_ptr p
      );
    static ::InputMgrBindingsIdl_ptr nil (void);
    static ::CORBA::Boolean marshal (
        const ::InputMgrBindingsIdl_ptr p,
        TAO_OutputCDR & cdr
      );
  };
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 void operator<<= (::CORBA::Any &, InputMgrBindingsIdl_ptr); // copying
 void operator<<= (::CORBA::Any &, InputMgrBindingsIdl_ptr *); // non-copying
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, InputMgrBindingsIdl_ptr &);
TAO_END_VERSIONED_NAMESPACE_DECL
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const InputMgrBindingsIdl_ptr );
 ::CORBA::Boolean operator>> (TAO_InputCDR &, InputMgrBindingsIdl_ptr &);
