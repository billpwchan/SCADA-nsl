...
#ifndef _TAO_IDL_G__BIN_P530_SRC_SCS_IDL_TIMECLIENT_H_
#define _TAO_IDL_G__BIN_P530_SRC_SCS_IDL_TIMECLIENT_H_
...
#if !defined (_TIMECLIENTIDL__VAR_OUT_CH_)
#define _TIMECLIENTIDL__VAR_OUT_CH_

class TimeClientIdl;
typedef TimeClientIdl *TimeClientIdl_ptr;
...
#if !defined (_TIMECLIENTIDL_CH_)
#define _TIMECLIENTIDL_CH_

class  TimeClientIdl
  : public virtual ::ScsProcessIdl
{
public:
  friend class TAO::Narrow_Utils<TimeClientIdl>;
  typedef TimeClientIdl_ptr _ptr_type;
  typedef TimeClientIdl_var _var_type;
  typedef TimeClientIdl_out _out_type;
  
  // The static operations.
  static TimeClientIdl_ptr _duplicate (TimeClientIdl_ptr obj);
  
  static void _tao_release (TimeClientIdl_ptr obj);
  
  static TimeClientIdl_ptr _narrow (::CORBA::Object_ptr obj);
  static TimeClientIdl_ptr _unchecked_narrow (::CORBA::Object_ptr obj);
  static TimeClientIdl_ptr _nil (void)
  {
    return static_cast<TimeClientIdl_ptr> (0);
  }
...
private:
  TAO::Collocation_Proxy_Broker *the_TAO_TimeClientIdl_Proxy_Broker_;
...
protected:
  ...
  virtual void TimeClientIdl_setup_collocation (void);
  ...
  virtual ~TimeClientIdl (void);

private:
  // Private and unimplemented for concrete interfaces.
  TimeClientIdl (const TimeClientIdl &);
  
  void operator= (const TimeClientIdl &);
};
...
extern  ::CORBA::TypeCode_ptr const _tc_TimeClientIdl;
...
(*_TAO_TimeClientIdl_Proxy_Broker_Factory_function_pointer) (
...
#if !defined (_TIMECLIENTIDL__TRAITS_)
#define _TIMECLIENTIDL__TRAITS_
  
  template<>
  struct  Objref_Traits< ::TimeClientIdl>
  {
    static ::TimeClientIdl_ptr duplicate (
        ::TimeClientIdl_ptr p
      );
    static void release (
        ::TimeClientIdl_ptr p
      );
    static ::TimeClientIdl_ptr nil (void);
    static ::CORBA::Boolean marshal (
        const ::TimeClientIdl_ptr p,
        TAO_OutputCDR & cdr
      );
  };
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 void operator<<= (::CORBA::Any &, TimeClientIdl_ptr); // copying
 void operator<<= (::CORBA::Any &, TimeClientIdl_ptr *); // non-copying
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, TimeClientIdl_ptr &);
TAO_END_VERSIONED_NAMESPACE_DECL
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const TimeClientIdl_ptr );
 ::CORBA::Boolean operator>> (TAO_InputCDR &, TimeClientIdl_ptr &);
