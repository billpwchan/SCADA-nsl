...
#ifndef _TAO_IDL_G__BIN_P530_SRC_DAC_IDL_DACSIMCLIENT_H_
#define _TAO_IDL_G__BIN_P530_SRC_DAC_IDL_DACSIMCLIENT_H_
...
#if !defined (_DACSIMCLIENTIDL__VAR_OUT_CH_)
#define _DACSIMCLIENTIDL__VAR_OUT_CH_

class DacSimClientIdl;
typedef DacSimClientIdl *DacSimClientIdl_ptr;
...
#if !defined (_DACSIMCLIENTIDL_CH_)
#define _DACSIMCLIENTIDL_CH_

class  DacSimClientIdl
  : public virtual ::ScsProcessIdl
{
public:
  friend class TAO::Narrow_Utils<DacSimClientIdl>;
  typedef DacSimClientIdl_ptr _ptr_type;
  typedef DacSimClientIdl_var _var_type;
  typedef DacSimClientIdl_out _out_type;
  
  // The static operations.
  static DacSimClientIdl_ptr _duplicate (DacSimClientIdl_ptr obj);
  
  static void _tao_release (DacSimClientIdl_ptr obj);
  
  static DacSimClientIdl_ptr _narrow (::CORBA::Object_ptr obj);
  static DacSimClientIdl_ptr _unchecked_narrow (::CORBA::Object_ptr obj);
  static DacSimClientIdl_ptr _nil (void)
  {
    return static_cast<DacSimClientIdl_ptr> (0);
  }
  ...
  virtual void notifyEOV (
      const ::StringList & varNames,
...
private:
  TAO::Collocation_Proxy_Broker *the_TAO_DacSimClientIdl_Proxy_Broker_;

protected:
  // Concrete interface only.
  DacSimClientIdl (void);
  
  // These methods travese the inheritance tree and set the
  // parents piece of the given class in the right mode.
  virtual void DacSimClientIdl_setup_collocation (void);
  ...
  virtual ~DacSimClientIdl (void);

private:
  // Private and unimplemented for concrete interfaces.
  DacSimClientIdl (const DacSimClientIdl &);
  
  void operator= (const DacSimClientIdl &);
};
...
extern  ::CORBA::TypeCode_ptr const _tc_DacSimClientIdl;
...
(*_TAO_DacSimClientIdl_Proxy_Broker_Factory_function_pointer) (
...
#if !defined (_DACSIMCLIENTIDL__TRAITS_)
#define _DACSIMCLIENTIDL__TRAITS_
  
  template<>
  struct  Objref_Traits< ::DacSimClientIdl>
  {
    static ::DacSimClientIdl_ptr duplicate (
        ::DacSimClientIdl_ptr p
      );
    static void release (
        ::DacSimClientIdl_ptr p
      );
    static ::DacSimClientIdl_ptr nil (void);
    static ::CORBA::Boolean marshal (
        const ::DacSimClientIdl_ptr p,
        TAO_OutputCDR & cdr
      );
  };
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 void operator<<= (::CORBA::Any &, DacSimClientIdl_ptr); // copying
 void operator<<= (::CORBA::Any &, DacSimClientIdl_ptr *); // non-copying
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, DacSimClientIdl_ptr &);
TAO_END_VERSIONED_NAMESPACE_DECL
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const DacSimClientIdl_ptr );
 ::CORBA::Boolean operator>> (TAO_InputCDR &, DacSimClientIdl_ptr &);
