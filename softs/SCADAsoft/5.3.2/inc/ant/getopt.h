...
//       author: olivier
// --------------------------------------------------------------------------
// $Id: getopt.h,v 1.2 1999/02/15 14:48:09 ylo Exp $
//
//
// --------------------------------------------------------------------------
/* Getopt for GNU. 
...
#define AntGetOpt ScsAntGetOpt

class SCSERROR_API AntGetOpt
{
private:
...
public:
  ...
  AntGetOpt (int argc, char **argv, const char *optstring);
  int operator () (void);
};
