...
public:
  ...
  */
  ...
  /**
     ...
     \li \c !=ScsValid : in other case.
  */
  int setEndTime(const char* taskName, long long endTime, const char* clientName = NULL) const;
  ...
  */
  ...
  /**
     ...
     \li \c !=ScsValid : in other case.
  */
  int setStartTime(const char* taskName, long long startTime, const char* clientName = NULL) const;
  /**
     \par Description:
