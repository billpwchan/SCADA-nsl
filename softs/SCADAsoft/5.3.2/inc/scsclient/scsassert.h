...
#define SCS_ASSERT(condition) SCS_Assert<SCS_AssertException>(condition,  __FILE__, __LINE__)
...
#define SCS_PRECONDITION(condition) SCS_Assert<SCS_PreconditionException>(condition, __FILE__, __LINE__)

/** Use this macro to verify the exit conditions of a function.  */
#define SCS_POSTCONDITION(condition) SCS_Assert<SCS_PostconditionException>(condition, __FILE__, __LINE__)
