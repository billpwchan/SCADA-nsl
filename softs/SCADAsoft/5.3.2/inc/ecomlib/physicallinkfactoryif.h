...
class ECOMLIBIF_EXPORT PhysicalLinkFactoryIF {
 ...
 public:
  ...
  /**
    * Sets the redundancy options for the PLC as they are written in the XML configuration file.
    * To be called before `getLinks()`.
    */

  virtual void setPLCRedundancyOptions(const RedundancyOptions& options) 
  {
    _plcRedundancyOptions = options;
  }

  RedundancyOptions getPLCRedundancyOptions() const
  {
    return _plcRedundancyOptions;
  }
 ...
 private:
  ...
  RedundancyOptions _plcRedundancyOptions;
};
}
