...
class ECOMLIBIF_EXPORT PhysicalLinkRqstVisitorIF {
 ...
 public:
  ...
  /** Informs the DacCom that we are going online. */

  virtual void visit(GoOnlineRqst&) { }

  /** Informs the DacCom that we are going standby. */

  virtual void visit(GoStandbyRqst&) { }
