...
{
  POA_FtRtecEventComm::PushConsumer * const impl = static_cast<POA_FtRtecEventChannelAdmin::EventChannelFacade *> (servant);
...
{
  POA_RtecEventChannelAdmin::EventChannel * const impl = static_cast<POA_FtRtecEventChannelAdmin::EventChannel *> (servant);
...
{
  POA_FtRtecEventComm::PushConsumer * const impl = static_cast<POA_FtRtecEventChannelAdmin::EventChannel *> (servant);
  POA_FtRtecEventComm::PushConsumer::push_skel (
      server_request,
      servant_upcall,
      impl
...
{
  POA_FtRtecEventChannelAdmin::EventChannelFacade * const impl = static_cast<POA_FtRtecEventChannelAdmin::EventChannel *> (servant);
...
{
  POA_FTRT::Updateable * const impl = static_cast<POA_FtRtecEventChannelAdmin::EventChannel *> (servant);
...
{
  POA_FTRT::FaultListener * const impl = static_cast<POA_FtRtecEventChannelAdmin::EventChannel *> (servant);
...
{
  POA_FTRT::ObjectGroupManager * const impl = static_cast<POA_FtRtecEventChannelAdmin::EventChannel *> (servant);
