 ...
 *  @file Transport.h
 *
 *  $Id: Transport.h 1219 2009-06-26 20:24:08Z mitza $
 *
...
public:
  ...
  Drain_Result handle_output (ACE_Time_Value *max_wait_time);
...
private:
   ...
   */
  Drain_Result drain_queue (ACE_Time_Value *max_wait_time);

  /// Implement drain_queue() assuming the lock is held
  Drain_Result drain_queue_i (ACE_Time_Value *max_wait_time);
