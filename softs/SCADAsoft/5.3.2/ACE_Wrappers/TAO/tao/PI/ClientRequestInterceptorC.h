...
#ifndef _TAO_PIDL_PI_CLIENTREQUESTINTERCEPTORC_H_
#define _TAO_PIDL_PI_CLIENTREQUESTINTERCEPTORC_H_

#include /**/ "ace/pre.h"

#ifndef TAO_PI_SAFE_INCLUDE
#error You should not include PI/ClientRequestInterceptorC.h, use tao/PI/PI.h
