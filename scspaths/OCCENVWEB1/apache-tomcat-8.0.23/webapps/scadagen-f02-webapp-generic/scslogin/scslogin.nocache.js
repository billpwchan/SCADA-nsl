function scslogin(){
  ...
  $stats && $stats({moduleName:'scslogin', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'begin'});
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      var iframe = $doc_0.getElementById('scslogin');
      ...
      scslogin = null;
      frameWnd.gwtOnLoad(onLoadErrorFunc, 'scslogin', base, softPermutationId);
      $stats && $stats({moduleName:'scslogin', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'end'});
    }
  }
  ...
  function computeScriptBase(){
    ...
    function tryNocacheJsTag(){
      ...
      for (var i_0 = 0; i_0 < scriptTags.length; ++i_0) {
        if (scriptTags[i_0].src.indexOf('scslogin.nocache.js') != -1) {
    ...
    function tryMarkerScript(){
      ...
      if (typeof isBodyLoaded == 'undefined' || !isBodyLoaded()) {
        var markerId = '__gwt_marker_scslogin';
        var markerScript;
  ...
  function processMetas(){
    ...
    for (var i_0 = 0, n = metas.length; i_0 < n; ++i_0) {
      ...
      if (name_0) {
        name_0 = name_0.replace('scslogin::', '');
        if (name_0.indexOf('::') >= 0) {
          continue;
        }
  ...
  function maybeInjectFrame(){
    if (!frameInjected) {
      ...
      $stats && $stats({moduleName:'scslogin', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'moduleRequested'});
  ...
  scslogin.onScriptLoad = function(){
    if (frameInjected) {
      loadDone = true;
      maybeStartModule();
    }
  ...
  ;
  scslogin.onInjectionDone = function(){
    scriptsDone = true;
    $stats && $stats({moduleName:'scslogin', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'end'});
    maybeStartModule();
  }
  ;
  processMetas();
  ...
  var initialHtml;
  if (isHostedMode()) {
    if ($wnd_0.external && ($wnd_0.external.initModule && $wnd_0.external.initModule('scslogin'))) {
      $wnd_0.location.reload();
      return;
    }
    initialHtml = 'hosted.html?scslogin';
    strongName = '';
  }
  $stats && $stats({moduleName:'scslogin', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'selectingPermutation'});
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['DEBUG', 'gecko1_8'], 'E351E2216F22BF5F9FEE71E74CFFC4F4');
      unflattenKeylistIntoAnswers(['DEBUG', 'ie9'], 'E351E2216F22BF5F9FEE71E74CFFC4F4' + ':1');
      unflattenKeylistIntoAnswers(['DEBUG', 'safari'], 'E351E2216F22BF5F9FEE71E74CFFC4F4' + ':2');
      unflattenKeylistIntoAnswers(['INFO', 'gecko1_8'], 'E351E2216F22BF5F9FEE71E74CFFC4F4' + ':3');
      unflattenKeylistIntoAnswers(['INFO', 'ie9'], 'E351E2216F22BF5F9FEE71E74CFFC4F4' + ':4');
      unflattenKeylistIntoAnswers(['INFO', 'safari'], 'E351E2216F22BF5F9FEE71E74CFFC4F4' + ':5');
      unflattenKeylistIntoAnswers(['WARN', 'gecko1_8'], 'E351E2216F22BF5F9FEE71E74CFFC4F4' + ':6');
      unflattenKeylistIntoAnswers(['WARN', 'ie9'], 'E351E2216F22BF5F9FEE71E74CFFC4F4' + ':7');
      unflattenKeylistIntoAnswers(['WARN', 'safari'], 'E351E2216F22BF5F9FEE71E74CFFC4F4' + ':8');
  ...
  , 50);
  $stats && $stats({moduleName:'scslogin', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'end'});
  $stats && $stats({moduleName:'scslogin', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'begin'});
  ...
  $doc_0.write('<script defer="defer">scslogin.onInjectionDone(\'scslogin\')<\/script>');
}
