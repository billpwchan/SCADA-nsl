...
%JAVA_HOME32%\bin\java.exe -agentlib:jdwp=transport=dt_socket,address=localhost:9029,server=y,suspend=n -server %JAVA_OPTS% -cp ba_lib/*;ba_common_lib/*;last_lib/*;extra;extra/*;. %SCS_ARGS% com.thalesgroup.scadasoft.myba.Main